...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('properties_crops_pests', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('interference_factors_item_id');
            $table->string('incidency', 255);
            $table->decimal('quantity_per_meter', 8, 2);
            $table->decimal('quantity_per_square_meter', 8, 2);
    ...
    {
        Schema::dropIfExists('properties_crops_pests');
    }
};
