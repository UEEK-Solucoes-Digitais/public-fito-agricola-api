...
class WeedsExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    private $dataObject;
    ...
    public function collection()
    {
        ...
        foreach ($this->dataObject as $object) {
            $itens[] = [
                ...
                'weed' => $object->weed ?  $object->weed->name : "",
                'dae' => $this->getRisk($object->risk),
                'estadio' => $object->weed->observations,
    ...
    {
        return ["Propriedade", "Ano agrícola", "Cultura", "Cultivar", "Lavoura", "Data", "Daninha", "Nível de risco", "Observações", "Estádio", "Responsável"];
    }
}
