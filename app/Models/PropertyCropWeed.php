...
class PropertyCropWeed extends BaseModel
{
    protected $table = 'properties_crops_weeds';
    ...
    {
        return $this->hasMany(PropertyCropGallery::class, "object_id", "id")->where("type", 4)->where('status', 1);
    }
