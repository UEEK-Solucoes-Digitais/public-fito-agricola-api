...
class PropertyCropStage extends BaseModel
{
    protected $table = 'properties_crops_stage';
    protected $casts = [
    ...
    {
        return $this->hasMany(PropertyCropGallery::class, "object_id", "id")->where("type", 1)->where('status', 1);
    }
